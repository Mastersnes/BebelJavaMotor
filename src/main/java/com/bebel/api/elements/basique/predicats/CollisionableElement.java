...
public class CollisionableElement extends DrawableElement {
    public CollisionableElement(final String name, final TextureAsset image, final PhysicsAsset physics) {
        this(name, image, physics, 0, 0);
    }
    public CollisionableElement(final String name, final TextureAsset image, final PhysicsAsset physics, final float w, final float h) {
        super(name, image, w, h);
    ...
    public void activePhysics(final PhysicsAsset physics) {this.physics = physics.get();}
